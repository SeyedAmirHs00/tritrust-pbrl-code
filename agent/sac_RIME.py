...
class SACAgent(Agent):
    """SAC algorithm."""
    def __init__(self, obs_dim, action_dim, action_range, cfg, device):
        super().__init__()
        ...
        self.critic_tau = cfg.agent.params.critic_tau
        self.actor_update_frequency = cfg.agent.params.actor_update_frequency
        self.critic_target_update_frequency = cfg.agent.params.critic_target_update_frequency
        self.batch_size = cfg.agent.params.batch_size
        self.learnable_temperature = cfg.agent.params.learnable_temperature
        self.critic_lr = cfg.agent.params.critic_lr
        self.critic_betas = cfg.agent.params.critic_betas
        ...
        self.init_temperature = cfg.agent.params.init_temperature
        self.alpha_lr = cfg.agent.params.alpha_lr
        self.alpha_betas = cfg.agent.params.alpha_betas
        self.actor_betas = cfg.agent.params.actor_betas
        self.critic_hidden_dim = cfg.double_q_critic.params.hidden_dim
        self.critic_hidden_depth = cfg.double_q_critic.params.hidden_depth
        self.actor_hidden_dim = cfg.diag_gaussian_actor.params.hidden_dim
        self.actor_hidden_depth = cfg.diag_gaussian_actor.params.hidden_depth
        self.actor_log_std_bounds = cfg.diag_gaussian_actor.params.log_std_bounds

        self.critic = DoubleQCritic(
            obs_dim, action_dim, self.critic_hidden_dim, self.critic_hidden_depth).to(
            self.device)
        ...
        self.actor = DiagGaussianActor(
            obs_dim, action_dim, self.actor_hidden_dim, self.actor_hidden_depth,
            self.actor_log_std_bounds).to(self.device)
        self.log_alpha = torch.tensor(np.log(cfg.agent.params.init_temperature)).to(self.device)
        ...
        self.critic_optimizer = torch.optim.Adam(
            ...
            lr=cfg.agent.params.critic_lr,
            betas=cfg.agent.params.critic_betas)
        self.log_alpha_optimizer = torch.optim.Adam(
            [self.log_alpha],
            lr=cfg.agent.params.alpha_lr,
            betas=cfg.agent.params.alpha_betas)
